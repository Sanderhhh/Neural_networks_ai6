...
path = os.path.join("trainingdata", "data")
dataset = sys.argv[1] 
data = np.load(os.path.join("trainingdata", "{0}.npy".format(dataset)), allow_pickle=True)
...
print("Nr of images: ", len(bounding_boxes))
